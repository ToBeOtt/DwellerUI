...
export default function Navbar(props) {
  ...
  return (
    <header className="bg-dweller-green w-full shadow-xl">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                  ...
                  {products.map((item) => (
                    ...
                    >
                      <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-white">
                        <item.icon className="h-6 w-6 text-white-600 group-hover:text-white-600" aria-hidden="true" />
                      </div>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="/Login" className="mx-5 text-sm font-semibold leading-6 text-white no-underline">
            Log in <span aria-hidden="true">&rarr;</span>
          </a>
          <a href="/Register" className="text-sm font-semibold leading-6 text-white no-underline">
            Registrera 
          </a>
        </div>
      </nav>
        ...
        <Dialog.Panel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">Dwellers</span>
              <img
